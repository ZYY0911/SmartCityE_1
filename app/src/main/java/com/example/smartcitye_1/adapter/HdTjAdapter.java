...
/**
 * @Login Name win10
 * @Create by 张瀛煜 on 2020/10/15 at 16:24
 */
public class HdTjAdapter extends ArrayAdapter<HdInfo> {
    private int count;

    public HdTjAdapter(@NonNull Context context, @NonNull List<HdInfo> objects, int count) {
